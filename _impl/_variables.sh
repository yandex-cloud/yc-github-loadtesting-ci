...
# Number of agents which should be created when 'agent_create.sh' is called.
...
# env: YC_LT_AGENT_CREATE_TIMEOUT
# format: positive number
# Timeout on agents creation.
_def_var AGENT_CREATE_TIMEOUT "600"
...
# Labels of an agent created by 'agent_create.sh'
_def_var AGENT_LABELS "ci=true,author=${USER:-anon}"

# env: YC_LT_AGENT_NAME_PREFIX
# format: string
# Name (or prefix) of an agent created by 'agent_create.sh'
_def_var AGENT_NAME_PREFIX "ci-lt-agent"

# env: YC_LT_AGENT_DESCRIPTION
# format: string
# Description of an agent created by 'agent_create.sh'
_def_var AGENT_DESCRIPTION "Created via script by ${USER:-anon}"
